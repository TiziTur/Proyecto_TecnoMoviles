// Módulo Hilt que provee Retrofit y ApiService para inyección de dependencias.
// BASE_URL apunta al backend desplegado en Railway — cambiar la URL cuando esté disponible.
