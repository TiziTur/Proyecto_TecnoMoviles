        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    Column {
                        Text(
                            text = stringResource(R.string.home_welcome, MockData.currentUser.firstName),
                ...
                item {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(20.dp)) {
                            ...
                            Text(
                                text = "$ ${moneyFormat.format(MockData.totalThisMonth)}",
                            ...
                            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                                StatCard(
                                    ...
                                    value = MockData.recentPurchases.size.toString(),
                                    icon = Icons.Default.ShoppingCart,
                                    modifier = Modifier.weight(1f)
                                )
                                StatCard(
                                    label = stringResource(R.string.stat_supermarkets),
                                    value = MockData.purchases.map { it.supermarket }.distinct().size.toString(),
                ...
                if (MockData.recentPurchases.isEmpty()) {
                    item {
                        EmptyState(
                    ...
                    items(MockData.recentPurchases) { purchase ->
                        PurchaseCard(
